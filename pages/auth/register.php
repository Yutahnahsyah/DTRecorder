...
<body class="h-full">
  <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
    ...
    <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
      <form action="/config/register_handler.php" method="POST" class="space-y-6">
        <div class="flex gap-x-4">
          <div class="flex-1">
            <label for="firstName" class="block text-sm/6 font-medium text-gray-900">First Name <span class="text-red-500">*</span></label>
            <div class="mt-2">
          ...
          <div class="flex-1">
            <label for="lastName" class="block text-sm/6 font-medium text-gray-900">Last Name <span class="text-red-500">*</span></label>
            <div class="mt-2">
        ...
        <div>
          <label for="studentId" class="block text-sm/6 font-medium text-gray-900">Student Id <span class="text-red-500">*</span></label>
          <div class="mt-2">
        ...
        <div>
          <div class="flex items-center justify-between">
            <label for="confirm_password" class="block text-sm/6 font-medium text-gray-900">Confirm Password <span class="text-red-500">*</span></label>
          </div>
          <div class="mt-2">
